...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Spaceley[/B][/COLOR]Sprockets'
BUILDERNAME = 'OpenWizard'
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it.
BUILDFILE = 'https://tv.berryburchett.com/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Spaceley[/B][/COLOR][COLOR {color2}]Sprockets[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
